...
<div class="col-sm-3 sub_cards2">
        <div class="col-sm-12 card_image2"><img class="col-sm-12" src="images/c.jpg"/></div>
        <div class="col-sm-12 card_button2">
          <button type="button" class="btn btn-primary btn-block"><h3>C Tutorials</h3></button>
        </div>
      </div>
        <div class="col-sm-3 sub_cards2">
        <div class="col-sm-12 card_image2"><img class="col-sm-12" src="images/c2.jpg"/></div>
        <div class="col-sm-12 card_button2">
          <button type="button" class="btn  btn-primary btn-block"><h3>C# Tutorials</h3></button>
        </div>
      </div>
      <div class="col-sm-3 sub_cards2">
        <div class="col-sm-12 card_image2"><img class="col-sm-12" src="images/images.png"/></div>
        <div class="col-sm-12 card_button2">
          <button type="button" class="btn btn-primary btn-block"><h3>C++ Tutorials</h3></button>
        </div>
      </div>
